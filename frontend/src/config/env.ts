...
const env = {
  ...
  REGISTER_PROGRAM: process.env.NEXT_PUBLIC_REGISTER_PROGRAM!,
  REGISTER_QUEST1_PROGRAM: process.env.NEXT_PUBLIC_REGISTER_QUEST1_PROGRAM!,
  REGISTER_QUEST2_PROGRAM: process.env.NEXT_PUBLIC_REGISTER_QUEST2_PROGRAM!,
  ...
  ORACLE_PROGRAM: process.env.NEXT_PUBLIC_OFFICE_ORACLE_PROGRAM,
  ...
  FEES: {
    ...
    CREDIT_TRANSFER_PUBLIC: parseInt(process.env.NEXT_PUBLIC_FEES_CREDIT_TRANSFER_PUBLIC!),
  ...
  REQUEST_HASH: {
    SGX: process.env.NEXT_PUBLIC_SGX_REQUEST_HASH!,
    NITRO: process.env.NEXT_PUBLIC_NITRO_REQUEST_HASH!
  },
  ...
  QUEST_URL: process.env.NEXT_PUBLIC_QUEST_URL!,
  ENABLE_ARC21_TRANSFER: false
};
